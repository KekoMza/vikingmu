...
class Character {
	...
	public function CharacterClearSkillTree() {
		...
		// query
		$query = "UPDATE "._TBL_MASTERLVL_." SET "._CLMN_ML_POINT_." = :masterpoints, "._CLMN_ML_SKILL_." = null";
	...
	protected function _resetMagicList($character) {
		...
		//$result = $this->muonline->query("UPDATE "._TBL_MASTERLVL_." SET "._CLMN_ML_SKILL_." = null WHERE "._CLMN_ML_NAME_." = ?", array($character));
		if(!$result) return;
		return true;
	}
